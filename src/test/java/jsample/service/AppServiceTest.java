...
public class AppServiceTest {
    ...
    public void getAppsTest1() {
        ...
        StepVerifier.create(service.getApps())
                .assertNext(x -> Assertions.assertEquals(app1, x))
                .assertNext(x -> Assertions.assertEquals(app2, x))
                .assertNext(x -> Assertions.assertEquals(app3, x))
                .verifyComplete();
    ...
    public void getAppTest1() {
        ...
        Mockito.when(dao.findById(app2.getId())).thenReturn(Mono.just(app2));

        StepVerifier.create(service.getAppById(app2.getId()))
                .assertNext(x -> Assertions.assertEquals(app2, x))
                .verifyComplete();
    ...
    public void addAppTest1() {
        ...
        StepVerifier.create(service.addApp(app4))
                .assertNext(x -> Assertions.assertEquals(app4, x)).verifyComplete();
    ...
    public void deleteAppTest1() {
        ...
        StepVerifier.create(service.deleteApp("4"))
    ...
    public void updateAppTest1() {
        ...
        StepVerifier.create(service.updateApp(app4, "4"))
                .assertNext(x -> Assertions.assertEquals(app4, x))
                .verifyComplete();
